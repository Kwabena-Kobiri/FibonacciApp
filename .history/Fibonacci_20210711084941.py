...
button1 = Button(root, text='Generate Sequence', command=button_command, font=('bold', 10))
button1.grid(row=6,column=1, pady=50, sticky=W)

# Label for generated Fibonacci sequence
generated_label = Label(root, text='Generated Fibonacci Sequence', font=('bold',12), bg='#8e2de2', fg='white')
...
button2 = Button(root, text='Clear field', font=(10), fg='white', bg='#1e9688')
