""""
THIS IS A USER APPLICATION THAT PROVIDES AN INTERFACE WHICH IMPLEMENTS 
THE FIBONACCI SEQUENCE AT ITS CORE. 
THE APPLICATION INTERFACE ALLOWS USERS TO TYPE THE STARTING NUMBER (1),
AND THE NUMBER OF ELEMENTS TO BE GENERATED.
IT THEN GENERATES A FIBONACCI SEQUENCE BASED ON THE NUMBER OF 
